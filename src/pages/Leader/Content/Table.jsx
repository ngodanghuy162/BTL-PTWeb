...
export default function Table({
  ...
  const handleSetPageNumber = (pageNumber) => {
    if (pageNumber >= 0 && pageNumber < maxPage) setPageNumber(pageNumber);
  };
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full table-auto text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          {data
            .slice(pageNumber * numberPerPage, (pageNumber + 1) * numberPerPage)
            .map((row, index) => (
            ...
            <>
              <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                ...
                <span className="font-semibold text-gray-900 dark:text-white px-1">
                  {`${data.length === 0 ? 0 : pageNumber * numberPerPage + 1} - ${
                    pageNumber * numberPerPage + numberPerPage > data.length
                      ? data.length
                      : pageNumber * numberPerPage + numberPerPage
                  }`}
                </span>
                trên tổng số
              ...
              <ul className="inline-flex items-stretch -space-x-px">
                ...
                <li>
                  <input
                    type="text"
                    className="flex h-full border border-gray-300 hover:bg-gray-100 text-textColor1 dark:bg-gray-800 dark:border-gray-700 w-[40px] text-center focus-visible:ring-0"
                    value={pageNumber + 1}
                ...
                <li>
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M7.293 14.707a1 1 0 010-1.414L10.586 10l7.707 7.707a1 1 0 01-1.414 1.414l-8-8a1 1 0 010-1.414l8-8a1 1 0 011.414 0z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </button>
